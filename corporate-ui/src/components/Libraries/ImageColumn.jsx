...
const ImageColumn = () => {
  return (
    <div className="flex flex-col justify-center sm:flex-row  items-end gap-4 pt-12 md:pt-0 pb-16 h-full md:h-[400px]">
        ...
        <div className="relative z-10 p-6 h-full flex flex-col justify-between">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-2xl font-normal text-gray-800">98.7%</div>
      ...
      <div className="w-full md:w-1/5 h-[200px] md:h-4/5 rounded-xl bg-white border border-gray-100 relative overflow-hidden shadow-md">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-400 to-emerald-500"></div>
        <div className="p-5 h-full flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <FileText className="text-gray-600 w-7 h-7" strokeWidth={1} />
            <div className="text-right">
              <div className="text-xl font-normal text-gray-800">12.5K</div>
              <div className="text-xs text-gray-500">Resumes Processed</div>
            </div>
          </div>
      ...
      <div className="w-full md:w-1/5 h-[200px] md:h-3/5 rounded-xl bg-white border border-gray-100 relative overflow-hidden shadow-md">
        ...
        <div className="relative z-10 p-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <div className="text-lg font-normal text-gray-800">3.2s</div>
      ...
      <div className="w-full md:w-1/5 h-[200px] md:h-4/5 rounded-xl bg-white border border-gray-100 shadow-lg relative overflow-hidden">
        ...
        <div className="p-5 h-full flex flex-col justify-between">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-xl font-normal text-gray-800">85%</div>
      ...
      <div className="w-full md:w-1/5 h-[200px] md:h-full rounded-xl bg-gradient-to-b from-white to-gray-50 border-2 border-gray-100 relative overflow-hidden shadow-md">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(34,197,94,0.05),transparent_50%)]"></div>
        <div className="relative z-10 p-6 h-full flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <div className="p-2 bg-white rounded-lg shadow-sm">
              <Users className="text-gray-700 w-6 h-6" strokeWidth={1} />
            </div>
            <div className="text-right">
              <div className="text-2xl font-normal text-gray-800">1.2K</div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="flex items-center">
                ...
                <span className="text-gray-600">456</span>
              </div>
              <div className="flex items-center">
                <Briefcase className="w-3 h-3 mr-1 text-blue-500" />
                <span className="text-gray-600">89 Jobs</span>
              </div>
            </div>
          </div>
